...
% --- diagram 3 (not a function) ---
    ...
    \subsection{propositonele formules}
    Je kan ook propositonele formules op de volgende manier schrijven:
    $p, q ::= true | false | p \land q | p \lor q | \neg p | p \implies q | p \Leftrightarrow q$
    Door deze definitie kan je inductie gebruiken. Om te bewijzen dat een property R houdt voor alle propositonele formules, moet je de volgende stappen volgen:


    \section{Games incomplete}
