...
% ====================================================
    ...
    * De ``?name'' betekendt hetzelde als ``<http://xmlns.com/foaf/0.1/name>'' maar dan korter geschreven.
    ...
    \subsection{Het geneste model INCOMPLEET}
    Tamara Munzner heeft het geneste model ontwikkeld om het proces van het ontwerpen van informatievisualisaties te structureren.
    Het model bestaat uit vier niveaus:
    \begin{itemize}
        \item \textbf{Domain problem and data character}: Begrijp het probleem en de data.
        \item \textbf{Data and task abstraction}: Abstracteer de data en taken.
        \item \textbf{Visual encoding and interaction design}: Ontwerp de visuele representatie en interactie.
        \item \textbf{Algorithm design}: Ontwerp de algoritmen voor het genereren van de visualisatie.
    \end{itemize}
