...
\begin{document}
    ...
    Onze website is terug te vinden op: \href{https://webspace.science.uu.nl/~9932003/}{https://webspace.science.uu.nl/~9932003/}.
    ...
    Dit is een website die alles rondom het leren van webdesign aanbiedt \parencite{W3S}.
    ...
    Dit achtergrondonderzoek is meer gericht op het onderzoek achter de gemaakte keuzes voor de opmaak, lay-out en API-implementatie voor onze website, doordat wij als team de kennis voor het ontwikkelen van een website al bezitten, waardoor we ons meer richten op de keuzes eromheen.
    ...
    De kleuren paars en blauw stralen deze aspecten uit \parencite{ned24}.
    ...
    Een verhuurbedrijf dat buiten het IJsselmeer aanbiedt, is: YachtCharter Westerdijk \parencite{Wes}.
    ...
    Een ander verhuurbedrijf buiten het IJsselmeer is YachtCharter Sneek \parencite{Yac}.
    ...
    Een verhuurbedrijf specifiek gericht op onder andere het IJsselmeer is: Andijk Jacht Verhuur \parencite{And}.
    ...
    Dit zorgt ervoor dat applicaties gegevens met elkaar kunnen uitwisselen \parencite{Log}.
     De API zorgt voor een communicatieverbinding tussen input en output \parencite{NCS}.
    ...
    Dit is een zogenaamde “Mock” API die voor gegenereerde data kan ophalen \parencite{Muh25}.
    ...
    Ook kan Open-Meteo actuele informatie geven over de wind, maximale en minimale temperatuur en of er neerslag komt \parencite{Ope1}.
    Om inspiratie op te doen is de website van Buienradar bekeken.
    Deze website geeft het actuele weer op een bepaalde plaats weer \parencite{Bui}.
    ...
    Dit is een platform dat een grote collectie aan designideeën aanbiedt \parencite{Dri}.
    ...
    Donkerblauw en paars zijn geselecteerd als hoofdkleuren, omdat onderzoek aantoont dat deze kleuren een luxe en betrouwbare indruk wekken \parencite{ned24}.
    ...
    Deze reviews vergroten het vertrouwen in zowel de service als de website \parencite{HuN14}.
    ...
    Deze API maakt het mogelijk om fictieve data op te halen zolang echte klantgegevens nog niet beschikbaar zijn \parencite{Muh25}.
    ...
    Naast toetsenbordtoegankelijkheid is ook het kleurgebruik van de website beoordeeld \parencite{Cyn17}.
    ...
    De hoge totaalscore van 0,97 geeft aan dat tekst en interactieve elementen in de meeste gevallen voldoende contrast hebben ten opzichte van hun achtergrond.
    ...
    Ondanks het feit dat er geen grootte, nieuwe design keuzes zijn gemaakt tussen het ontwerp en de implementatie, zijn er wel kleine verbeterpunten gevonden tijdens het realiseren van het ontwerp.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\columnwidth]{images/Afbeelding1}
        \caption{}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\columnwidth]{images/Afbeelding2}
        \caption{}
        \label{fig:afbeelding2}
    \end{figure}

    Dit is de HTML-code voor onze menubalk.
    De “back-end” werkt met <a> links, die verwijzen naar de andere html-bestanden.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\columnwidth]{images/Afbeelding3}
        \caption{}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\columnwidth]{images/Afbeelding4}
        \caption{}
    ...
    De .item a:hover, zorgt dat de achtergrond verandert als de gebruiker met de muis over een pagina hovert.
    ...
    Dit is gemaakt met een API, die willekeurige reviews genereert.
     Het API-endpoint dat we hiervoor gebruiken is: https://dummyjson.com/c/40df-7598-493f-b177
    ...
    Dit is de JavaScript code die hiervoor zorgt.
    Allereerst wordt via een fetch de data van het API-endpoint gehaald.
    De code daaronder gebruikt de verzamelde data en weergeeft het op de webpagina.
    Het API-endpoint levert alleen een score van 0 – 5, maar de visualisatie moeten wij zelf maken.
    ...
    Boat.image, boat.builder en nog een aantal details kunnen zo worden geselecteerd uit de JSON.
     Helemaal aan het einde van de zoekalgoritme functie, is ook nog een regel die eventuele fouten opvangt.
    ...
    Een ander ingewikkeld deel van de website is het linken tussen de boten/bestemmingen, en de extra informatie die wordt weergeven als erop wordt geklikt.
    ...
    Dit wordt op eenzelfde manier gedaan als het laden van de boten.
    ...
    Vervolgens wordt het id-nummer die door de link werd meegegeven gebruikt om de juiste boot/bestemming onder handen te nemen.
    ...
    Meestal kon de hele groep zich god vinden in wat de ontwikkelaar op zijn pagina gemaakt had, wat ervoor zorgde dat ook hier geen frictie ontstond.
    ...
    Echter was dit wel de eerste keer dat ik een website heb gemaakt waar Bootstrap gebruikt (moest) worden, dus dat was zeker een nieuwe ervaring en heeft me op dat gebied ook al wat meer kennis opgeleverd.
    ...
    \subsection*{Mika Kalshoven}
    Ik vond dit project erg goed gaan.
    De meeste van ons groepje hadden al ervaring met het maken van websites.
    Dit hele groepje doet ook de dubbele bachelor met informatica, dus dit is niet de eerste keer dat we hebben geprogrammeerd.
    Dit zorgde dat het verloop van het ontwikkelen van de site erg veel soepeler ging.
    Waar ik zelf wel moeite mee had, was het schrijven van het verslag.
    Gelukkig hebben een aantal andere teamleden juist daar weer veel ervaring in.
    Dit zorgde dat iedereen elkaars zwakte aanvulde.

    Wat voor mij wel helemaal nieuw was, is het gebruik van Bootstrap.
    Dit is iets wat ik zelf nog nooit heb gebruikt, en dit was heel interessant om voor deze opdracht wel te leren, en te gebruiken.

    De communicatie voor dit project vond ik zelf zeer aangenaam.
    Als ik een appje naar iemand stuurde, of een vraag had, kreeg ik snel een hulpvolle reactie terug.
    Dit maakt het samenwerken heel erg aangenaam, omdat, ook al heb ik ervaring met het ontwikkelen van websites, ik wist zeker niet het meest.
    Het is daarom heel fijn als je “domme” vragen kan stellen aan je teamgenoten, en een fijne reactie terug krijgen.

    Al met al, dit project was voor mij heel erg leerzaam.
    Ik heb heel veel nieuwe dingen over HTML, en vooral CSS geleerd.
    Daarnaast, heb ik het ook enorm naar mijn zin gehad tijdens dit project en heb ik mij op vele momenten helemaal stuk gelachen, wat natuurlijk ook belangrijk is tijdens een groepsproject.
